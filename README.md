...
접근성은 자동 검사로 심각·치명 위반이 없고, 키보드만으로 놀이를 열고 답하고 닫을 수 있음을 확인한 상태입니다. 완전한 WCAG 준수 판정에는 보조기기 실사용 테스트와 전문가 검토가 함께 필요합니다.
...
- 기기를 가로로 들어도 질문과 놀이 조작이 한 화면에 들어오는 가로 전용 배치
