(() => {
  ...
  const GAMES = {
    ...
    sizes: {
      ...
      rounds: [
        {
          helper: "셋 중 가장 큰 것을 골라요",
          prompt: "코끼리, 토끼, 개미 중 가장 큰 동물은 무엇일까?",
          speech: "코끼리, 토끼, 개미 중 가장 큰 동물은 무엇일까?",
          success: "쿵쿵! 코끼리가 가장 커!",
          options: [
            { label: "토끼", visual: "🐇", subtitle: "깡충깡충" },
            { label: "코끼리", visual: "🐘", subtitle: "쿵쿵", correct: true },
            { label: "개미", visual: "🐜", subtitle: "종종종" },
          ],
        },
        {
          helper: "이번에는 가장 작은 것을 찾아요",
          prompt: "수박, 사과, 딸기 중 가장 작은 과일은 무엇일까?",
          speech: "수박, 사과, 딸기 중 가장 작은 과일은 무엇일까?",
          success: "맞아! 셋 중에는 딸기가 가장 작아!",
          options: [
            { label: "수박", visual: "🍉", subtitle: "초록 줄무늬" },
            { label: "딸기", visual: "🍓", subtitle: "새콤달콤", correct: true },
            { label: "사과", visual: "🍎", subtitle: "아삭아삭" },
          ],
        },
        {
          helper: "마지막 크기 비교예요",
          prompt: "버스, 자전거, 킥보드 중 가장 큰 탈것은 무엇일까?",
          speech: "버스, 자전거, 킥보드 중 가장 큰 탈것은 무엇일까?",
          success: "부웅! 많은 사람이 타는 버스가 가장 커!",
          options: [
            { label: "킥보드", visual: "🛴", subtitle: "씽씽" },
            { label: "자전거", visual: "🚲", subtitle: "따르릉" },
            { label: "버스", visual: "🚌", subtitle: "부웅", correct: true },
          ],
        },
      ],
    },
